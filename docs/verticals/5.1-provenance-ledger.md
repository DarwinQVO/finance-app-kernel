...
**Domain 4: Research (Academic Publications)**

**Entity:** Publication
**Fields:** author, publication_year, journal, doi

**Scenario:** Publication year corrected after verifying with journal.
...
ProvenanceLedger.append({
  ...
  transaction_time: "2025-10-24T16:00:00Z",  // When researcher corrected
  valid_time_start: "2024-12-15",             // Actual online publication date
  value: 2024,
  previous_value: 2025                        // Assumed 2025 from preprint
})

// Query: "Show me 2024 publications as of Jan 1, 2025"
// Returns: Excludes this pub (we thought it was 2025 on Jan 1)
```
